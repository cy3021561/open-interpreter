...
from ..utils.get_coordinates import locate_all_text_on_screen, custom_screenshot, mark_text_on_image
...
class Display:
    ...
    def find_field_coordinates(self):
        """
        Finds the coordinates of all possible fields in a screenshot.
        """
        coordinate_list = {}
